    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="cadastro.html"><button type="button" class="btn btn-outline-success">Inserir novo usuário</button></a>
                <a href="deleteall.php"><button type="button" class="btn btn-outline-danger">Excluir todos os usuários</button></a>
            </div>
        </div>
    </div>
